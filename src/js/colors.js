...
let colors = {
  hexToRGB: function(hex_color){
    ...
    if(hex_color_validation.test(hex_color)){
      ...
      //Split into parts
      let r = colors.hexToInt(hex_color.substr(0, 2));
      let g = colors.hexToInt(hex_color.substr(2, 2));
      let b = colors.hexToInt(hex_color.substr(4, 2));
